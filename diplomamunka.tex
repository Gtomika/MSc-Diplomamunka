...
<advanced title="[Cím]">
 <![CDATA[
  [Formázott szöveg]
	...
	A programozás oktatásánál elengedhetetlen, hogy kódrészletekkel segítsük a megértést.
	
	\subsubsection{Formázás}
	
	A tananyagban lévő mintáknak egységes formázásúnak kell lenniük. Ezt úgy értem el, hogy előre definiáltam a színeket, amelyekkel a kód részeit kijelöltem. A következők kaptak saját kijelölőszínt:
...
<code>
 <![CDATA[
  [Formázott kód]
	...
	Itt látható néhány kódminta az alkalmazásból:
